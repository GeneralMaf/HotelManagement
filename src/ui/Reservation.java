...
public class Reservation extends javax.swing.JFrame {
    ...
    public Reservation(Boolean b, Reservations r) {
        initComponents();
        ...
        r1 = r;
         if (b1 != null) {
            if (b1) {
                try {
                    int row = ReservationsDao.deletereservation(r);
                    if (row != 0) {
                        JOptionPane.showMessageDialog(this, "supprimer!");
                        getreservation();
                        getformulaire();
                    } else {
                        JOptionPane.showMessageDialog(this, "Il y'a erreur!");
                    }
    ...
    private void getreservation() {
        try {
            ...
            UtilsFonction.displayDataInTable(mylist, reservationstb, List.of("user_id", "reservation_id", "room_id", "created_at"));
        } catch (SQLException ex) {
            Logger.getLogger(Reservation.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(Reservation.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void getformulaire() {
        reservationstb.getSelectionModel().addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting()) {
                int selectedRow = reservationstb.getSelectedRow();
                if (selectedRow != -1) {
                    ...
                    try {
                        ...
                        if (r != null) {
                            nametf.setText(r.getClient_name());
                            emailtf.setText(r.getClient_email());
                            phonetf.setText(r.getClient_phone());
                            dateintf.setDatoFecha(r.getCheck_in_date());
                            dateouttf.setDatoFecha(r.getCheck_out_date());
                            statustf.setText(r.getStatus());
    ...
    private void initComponents() {
        ...
        reservationstb = new javax.swing.JTable();
        ...
        reservationstb.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(reservationstb);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        try {
            List<Reservations> mylist = ReservationsDao.getreservations();
            int selectedRow = reservationstb.getSelectedRow();
            r1=mylist.get(selectedRow); this.setVisible(false);
    ...
    private javax.swing.JTable reservationstb;
